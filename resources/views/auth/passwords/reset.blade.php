            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                    <div class="mb-lg-9 mb-5">
                        ...
                        <p>{{trans("message.forget_password_sent_code_description")}}</p>
                    </div>

                    <form method="POST" action="{{ route("verifyAndReset") }}" class="needs-validation
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="username" name="username"
                                       placeholder="{{trans("message.phone_number")}}" required value="{{ $username }}" readonly/>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="code" name="code"
                                       placeholder="{{trans("message.verify_code")}}" required />
                            </div>
