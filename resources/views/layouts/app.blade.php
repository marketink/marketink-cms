                                    ...
                                    <div class="row g-4 p-3 flex-fill">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                ...
                                                <img class="card-img rounded"
                                                    src="/assets/platform/images/blog/16by9/small/01.jpg"
                                                    alt="Card image">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                <!-- Card img -->
                                                <img class="card-img rounded"
                                                    src="/assets/platform/images/blog/16by9/small/02.jpg"
                                                    alt="Card image">
                                                <div class="card-body px-0 pt-3">
                                                    <h6 class="card-title mb-0"><a href="#"
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="card bg-transparent">
                                                <!-- Card img -->
                                                <img class="card-img rounded"
                                                    src="/assets/platform/images/blog/16by9/small/03.jpg"
                                                    alt="Card image">
                                                <div class="card-body px-0 pt-3">
                                                    <h6 class="card-title mb-0"><a href="#"
    ...
    <footer class="bg-dark pt-5">
        <div class="container">
            ...
            <div class="row pt-3 pb-4">
                ...
                <div class="col-md-5">
                    <p class="text-body-secondary">The next-generation blog, news, and magazine theme for you to start
                        sharing your stories today! This Bootstrap 5 based theme is ideal for all types of sites that
                        deliver the news.</p>
                </div>
                <div class="col-md-4">
                    <!-- Form -->
            ...
            <div class="row pt-5">
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <p class="text-body-secondary">Download our App and get the latest Breaking News Alerts and latest
                        headlines and daily articles near you.</p>
                    <div class="row g-2">
                        <div class="col">
                            <a href="#"><img class="w-100" src="/assets/platform/images/app-store.svg"
                                    alt="app-store"></a>
                        </div>
                        <div class="col">
                            <a href="#"><img class="w-100" src="/assets/platform/images/google-play.svg"
                                    alt="google-play"></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-dark-overlay-3 mt-5">
            <div class="container">
                <div class="row align-items-center justify-content-md-between py-4">
                    <div class="col-md-6">
                        <!-- Copyright -->
                        <div class="text-center text-md-start text-primary-hover text-body-secondary">©2024 <a
